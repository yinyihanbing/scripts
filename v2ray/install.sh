...
# 安装#  bash <(curl -sL https://raw.githubusercontent.com/yinyihanbing/scripts/master/v2ray/install.sh)
# 卸载#  bash <(curl -sL https://raw.githubusercontent.com/yinyihanbing/scripts/master/v2ray/install.sh) uninstall
# 状态#  bash <(curl -sL https://raw.githubusercontent.com/yinyihanbing/scripts/master/v2ray/install.sh) info
echo "#############################################################"
...
function installV2ray()
{
    ...
    if [ ! -f /etc/v2ray/config.json ]; then
        bash <(curl -sL https://raw.githubusercontent.com/yinyihanbing/scripts/master/v2ray/goV2.sh)
        if [ ! -f /etc/v2ray/config.json ]; then
            echo "安装失败"
            exit 1
        fi
